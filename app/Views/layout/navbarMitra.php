...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/css/navbarMitra.css">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card__picture">
                                            <img src="<?= base_url() ?>/assets/image/<?= $userInfo['gambar'] ?>">
                                        </div>
                                        <div class="card__name">
                                            <h3 class="card__name-text"><?= ucfirst($userInfo['nama']) ?></h3>
                                            <div class="card__balance-point">
                                                <p class="card__balance-text">
                                                    <i class="uil uil-location-point"></i> <?= $userInfo['kota']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card__name">
                                <h3 class="card__name-text"><?= $userInfo['nama'] ?></h3>
                                <div class="card__balance-point">
                                    <p class="card__balance-text">
                                        <i class="uil uil-location-point"></i> <?= $userInfo['kota']; ?>
                                    </p>
