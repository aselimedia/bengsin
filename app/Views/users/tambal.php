    ...
    <div class="bensin__content-filter" id="bensin-content">
        <div class="bensin__menu">
            <div class="container">
                ...
                <form action="<?= base_url('/tambal-ban') ?>" method="post">
                    <div class="daerah">
                        <h6>Daerah</h6>
            ...
            <div class="row">
                <?php foreach ($jenisUsaha as $usaha) : ?>
                    <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                        <a href="<?= base_url() ?>/tambal-ban/detail/<?= $usaha['slug'] ?>">
                            <div class="box" onclick="location.href='<?= base_url() ?>/tambal-ban/detail/<?= $usaha['slug'] ?>'">
