...
<main>
    <div class="bg_login">
        <div class="container">
            <h1 class="txt">LOGIN MITRA</h1>
            <p class="txt_hai">Hi Mitra, Have a Good day!</p>
            ...
            <?php endif; ?>
            <form class="login-page" action="<?= base_url('/mitra/login'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-12">
                        <input type="email" class="form-control form-login" name='email' placeholder="Email">
                    </div>
                    <div class="col-12">
    ...
    <div>
        <p style="text-align: center; font-weight: 600;">Dont have an Account?
            <a href="<?= site_url('/mitra/register') ?>" style="color: #ed5a00; text-decoration:none; font-weight: 700;"> SIGN UP</a>
        </p>
    </div>
</main>
